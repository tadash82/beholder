    ...
    var e,
      ...
      d = {
        ...
        calculateWidgetHeight: function (e, t) {
          ...
          return r && t && (this.embedStylesForFullHeight(o + i, n, t), n)
            ? 100 + i
            : n
            ? "calc(" + o + i + " - 32px)"
            : o + i;
        ...
        MediumWidget: function (e) {
          ...
          switch (e.chartType) {
            ...
            case "line": {
              const { chartType: t, color: i } = e;
              o = { chartType: t, color: i };
              break;
            }
            case "area":
            default: {
      ...
      (d.MediumWidget.prototype = {
        ...
        widgetCode: function () {
          ...
          var p = this.options.chartOnly ? "&chartOnly=1" : "",
            ...
            w = "/mediumwidgetembed/";
          this.options.customer && (w = "/" + this.options.customer + w);
          var b =
            d.getHost(this.options) +
            w +
            "?" +
        ...
        create: function () {
          ...
          o && o.parentElement && o.parentElement.removeChild(o),
            ...
            t.postMessage.on("openChartInPopup", function (e) {
              for (
                var o = d.cloneSimpleObject(t.options),
                  i = ["symbol", "interval"],
                  r = i.length - 1;
                r >= 0;
                r--
              ...
              if (
                ...
                for (
                  var i = document.getElementsByTagName("a"),
                    r = new RegExp("/v/" + o.options.chart + "/$"),
                    n = new RegExp(
          ...
          window.addEventListener("message", function (e) {
            ...
            if (r && r.provider && "TradingView" === r.provider)
              if (((r.source = e.source), "get" === r.type)) {
                ...
                o[r.client_id] &&
                  o[r.client_id][r.id] &&
                  (o[r.client_id][r.id].call(r, r.data),
                  delete o[r.client_id][r.id]);
              else if ("post" === r.type) {
                if (!i[r.name]) return;
                i[r.name].forEach(function (e) {
